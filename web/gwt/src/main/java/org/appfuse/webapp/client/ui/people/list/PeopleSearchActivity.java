...
import org.appfuse.webapp.client.requests.PersonRequest;
...
public class PeopleSearchActivity extends AbstractProxySearchActivity<PersonProxy, String> {
	...
	@Override
	protected ProxySearchView<PersonProxy, String> createView() {
	...
	@Override
	protected Request<Long> createCountRequest(RequestContext requestContext, String searchCriteria) {
		return ((PersonRequest) requestContext).count(searchCriteria);
	}
	
	@Override
	protected Request<List<PersonProxy>> createSearchRequest(
			RequestContext requestContext, String searchCriteria, 
...
//		}
		...
		return ((PersonRequest) requestContext)	.search(searchCriteria, 
