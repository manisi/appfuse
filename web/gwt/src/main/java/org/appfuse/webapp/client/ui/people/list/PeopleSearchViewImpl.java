...
public class PeopleSearchViewImpl extends AbstractProxySearchView<PersonProxy, PeopleSearchCriteriaProxy> implements PeopleSearchView, Editor<PeopleSearchCriteriaProxy> {

    interface Binder extends UiBinder<Widget, PeopleSearchViewImpl> { }
    private static final Binder uiBinder = GWT.create(Binder.class);

	interface Driver extends SimpleBeanEditorDriver<PeopleSearchCriteriaProxy, PeopleSearchViewImpl> { }	
    ...
    @Override
    public EditorDriver<PeopleSearchCriteriaProxy> getEditorDriver() {
    	return editorDriver;
    }
    
    @Override
    public void setSearchCriteria(PeopleSearchCriteriaProxy searchCriteria) {
